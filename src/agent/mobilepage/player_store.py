...
store_menu=[
    ...
    {'value':4,'label':'消耗材料(200积分)','credit':200,'items':[
        ...
        {'value':'box00003','label':'上乘武功精气(数量20)','amount':20},
        {'value':'box00013','label':'上乘内功精气(数量20)','amount':20},
        {'value':'ess20003','label':'最高级青蓝精气(蓝色)数量10','amount':10},
        {'value':'ess10003','label':'最高级赤红精气(红色)数量10','amount':10},
        {'value':'ess00003','label':'最高级洪门精气(黄色)数量10','amount':10},
